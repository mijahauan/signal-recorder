...
start)
    ...
    for freq_mhz in 2.5 5 10 15 20 25; do
        ...
        # Run at lower priority (nice 10) on cores 4-15 to not interfere with radiod (0-1) or recorder (2-3)
        nohup taskset -c 4-15 nice -n 10 $PYTHON -m grape_recorder.grape.phase2_analytics_service \
